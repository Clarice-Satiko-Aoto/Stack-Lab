...
with col2:
    st.image("app\LogoKoalas.png", width=120)
...
# membro1
    col1,col2,col3 = st.columns([1,2,3])
    with col1:
            st.image("app\Clarice.png", width=100)
...
# membro2
    col1,col2,col3 = st.columns([1,2,3])
    with col1:
            st.image("app\Isis.png", width=100)
...
# membro3
    ...
    with col1:
            st.image("app\marcos.png", width=100)
...
# membro4
    col1,col2,col3 = st.columns([1.2,3,3])
    with col1:
            st.image("app\Octavio.png", width=100)
...
# membro5
    col1,col2,col3 = st.columns([1,2,3])
    with col1:
            st.image("app\Peterson.png", width=100)
